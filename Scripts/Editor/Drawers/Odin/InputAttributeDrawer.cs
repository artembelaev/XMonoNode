...
namespace XNodeEditor {
	public class InputAttributeDrawer : OdinAttributeDrawer<XMonoNode.InputAttribute> {
		...
		protected override void DrawPropertyLayout(GUIContent label) {
			...
			if (!NodeEditor.inNodeEditor) {
				if (Attribute.backingValue == XMonoNode.ShowBackingValue.Always || Attribute.backingValue == XNode.ShowBackingValue.Unconnected && !port.IsConnected)
